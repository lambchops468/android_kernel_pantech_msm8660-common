...
#define BATT_THERM_OPERATIONAL_HOT_RESTART (BATT_THERM_OPERATIONAL_MAX_CELCIUS-4)
#define BATT_THERM_OPERATIONAL_HOT_THROTTLE (BATT_THERM_OPERATIONAL_MAX_CELCIUS-5)
#define BATT_THERM_OPERATIONAL_HOT_UNTHROTTLE (BATT_THERM_OPERATIONAL_MAX_CELCIUS-6)
#else
