...
#ifdef CONFIG_MSM_VIDC_COMPAT
// This was removed by "749dd461d6 ion: remove obsolete ion flags"
// This was the only functional change out of many chunks in that commit.
// There is a good chance that the change was made in error.
